...
<head>
  <style>
    ...
    .illustration{
      ...
      margin-top: 20px;
      margin-left: 40%;
      border-bottom: 2px #01737e dotted;
      opacity: 0;
    }
  ...
  <main>
    <p>
      <section style="display: block; width: 100%;">
        <h4 class="header-dif"><span style="display: inline-block;width: 55%;text-align: center;font-size: 13px;">PVE SANS  DOMMAGES: {{now()->year}} / {{sprintf('%04d', $num_pv->num_pv)}}* </span> @if(auth()->user()->previllege != 'expert' )<span style="display: inline-block;width: 45%;text-align: center;"> STATUT: {{$Status_expertise->libelle}}</span>@endif</h4>
      </section>
        ...
        <div style="font-size:12px;width:47.9% !important;border:1px black solid;border-radius: 5px; position: relative !important; display: inline-block; padding: 10px 2px 10px 2px; margin-left: 1%; vertical-align: top;padding-bottom: 10px;height: 315px;">
          ...
          <ul style="font-weight: bold;margin-left: -40px;margin-top: 0px;padding:15px 30px;">
            ...
            <li style="display: block;width: 90%; margin: -7px auto;">
              ...
              <span style="font-weight: normal;float: right;background-color: white;padding:5px; border-radius: 1px;margin-top:-5px;width: 57%;">{{$AutreExpertise->$immobilisation}} JOURS</span>
            </li> --}}
          </ul>
        </div>
      </section>
      ...
      <section style="display: block; width: 100%;margin-top: 15px;clear: both;margin-left: 10px;">
          ...
          <h1 style="padding: 10px 5px; margin: 0; margin-bottom: 0px;text-align: center;background-color: #01737e;color:white;margin-right: -3px;margin-top: -11px;width: 100%;margin-left: -2px;border-radius: 5px 5px 0 0">R . A . S</h1>
      ...
      {{-- <section style="display: block; width: 100%;margin-top: 15px;clear: both;margin-left: 10px;">
        <div style="font-size:12px;width:32% !important;border:1px black solid;border-radius: 5px; position: relative !important; display: inline-block; padding: 10px 2px 10px 2px; margin-left: -10px; vertical-align: top;margin-top:0px;height: 50px;">

          <h3 style="padding: 10px 5px; margin: 0; margin-bottom: 0px;text-align: center;background-color: #01737e;color:white;margin-right: -3px;margin-top: -11px;width: 100%;margin-left: -2px;border-radius: 5px 5px 0 0">Valeur du vehicule</h3>

          <p style="margin: 0; padding: 6px 10px;height: 145px;text-align: center; font-weight: bold; font-size: 15px;">{{ number_format($AutreExpertise->valeur, 2, ',', ' ')}} DA</p>
        </div>

        <div style="font-size:12px;width:32% !important;border:1px black solid;border-radius: 5px; position: relative !important; display: inline-block; padding: 10px 2px 10px 2px; margin-left: 1%; vertical-align: top;margin-top:0px;height: 50px;">

          <h3 style="padding: 10px 5px; margin: 0; margin-bottom: 0px;text-align: center;background-color: #01737e;color:white;margin-right: -3px;margin-top: -11px;width: 100%;margin-left: -2px;border-radius: 5px 5px 0 0">Service rendu</h3>

          <p style="margin: 0; padding: 6px 10px;height: 145px;text-align: center; font-weight: bold; font-size: 15px;">{{ number_format($AutreExpertise->service_epave, 2, ',', ' ')}} DA</p>
        </div>

        <div style="font-size:12px;width:32% !important;border:1px black solid;border-radius: 5px; position: relative !important; display: inline-block; padding: 10px 2px 10px 2px; margin-left: 1%; vertical-align: top;margin-top:0px;height: 50px;">

          <h3 style="padding: 10px 5px; margin: 0; margin-bottom: 0px;text-align: center;background-color: #01737e;color:white;margin-right: -3px;margin-top: -11px;width: 100%;margin-left: -2px;border-radius: 5px 5px 0 0">Montant total du prejudice subi</h3>

          <p style="margin: 0; padding: 6px 10px;height: 145px;text-align: center; font-weight: bold; font-size: 15px;">{{ number_format(($AutreExpertise->valeur-$AutreExpertise->service_epave), 2, ',', ' ')}} DA</p>
        </div>
      </section> --}}
       ...
       <section style="display: block; width: 100%;margin-top: 15px;clear: both;margin-left: 10px;">
        <div style="font-size:12px;width:100% !important;border:1px black solid;border-radius: 5px; position: relative !important; display: inline-block; padding: 10px 2px 10px 2px; margin-left: -10px; vertical-align: top;margin-top:0px;">
          ...
          <p style="margin: 0; padding: 6px 10px;height: 40px;font-size: 11px;">
              <br>
