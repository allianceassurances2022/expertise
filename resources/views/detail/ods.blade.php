    ...
    <div class="col-12">
        <div class="card m-b-30">
            <div class="card-header">
                <h4 class="header-title"> <span class="ion-android-friends"></span> Liste de tous les ODS</h4>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
            ...
            $('#expertise thead tr:eq(1) th').each( function (i) {
				...
				var table = $('#expertise').DataTable({
					...
					"columns": [
						...
						{"data": "agence", "orderable": true, "searchable": true},
