                    ...
                    <div class="card m-b-30">
                        <div class="card-header" id="headingOne">
                            <h5 class="mb-0 mt-0 font-16">
                                <a data-toggle="collapse" data-parent="#accordion3" href="#collapseThree" aria-expanded="true" aria-controls="collapseThree" class="text-dark"><i class="mdi mdi-folder-outline"></i> Ajouter Un Article <span class="ion-arrow-down-b"></span></a>
                            </h5>
                        </div>
                        <div id="collapseThree" class="collapse show " aria-labelledby="headingOne" data-parent="#accordion3" >
                            <div class="card-body ">
                                <form name="ajout_user" action="{{route('pieces.categorie')}}" method="POST">
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg-4" style="margin-top:-6px;">
                                            ...
                                            <div class="">
                                                <input type="text" id="libelle" name="libelle" class="form-control"  value="" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-2 text-right">
                                            <div class="form-group  ">
                                                <br>
                                                <input id="btn_ajouter_rdv" class="btn btn-success btn-block text-center" type="submit" value="Ajouter Categorie"  style="margin-top: 8px;">
                                            </div>
                                        </div>
