                ...
                <div id="accordion3" class="formulaire-recherche">
                    <div class="card m-b-30">
                        ...
                        <div id="collapseThree" class="collapse show " aria-labelledby="headingOne" data-parent="#accordion3" >
                            <div class="card-body ">
                                <form name="ajout_user" action="{{route('article.store')}}" method="POST">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2" style="margin-top:-6px;">
                                            ...
                                            <select class="form-control" id="categorie" name="categorie">
                                                ...
                                                <option value="{{$categoriePiece->id}}" @if ($categoriePiece->id==$identifiant) selected @endif>{{$categoriePiece->libelle}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-lg-3" style="margin-top:-6px;">
                                            ...
                                            <div class="">
                                                <input type="text" id="intitule" name="intitule" class="form-control"  value="" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-2 text-right">
                                            <div class="form-group">
                                                <br>
                                                <input id="btn_ajouter_rdv" class="btn btn-success btn-block text-center" type="submit" value="Ajouter Article"  style="margin-top: 8px;">
                                            </div>
                                        </div>
