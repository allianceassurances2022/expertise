		...
		<form action="{{route('expertise.store_other')}}" method="post">
			...
			<div class="row">
				...
				<div class="col-md-6">
					<h6><i class="ion-information-circled"></i> Information</h6>
					<div class="form-group row">
						<label class="col-sm-4 col-form-label col-form-label-sm">Taux de réforme</label>
						<input class="col-sm-6 col-form-label col-form-label-sm" type="number" class="form-control" required name="taux_reforme" value="{{$AutreExpertise->taux_reforme}}" id="couleur">
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-4">
					...
					<div class="form-group">
						<label>Valeur vénale avant sinistre</label>
				...
				<div class="col-md-4">
					<h6><i class="ion-information-circled"></i> Montant</h6>
					<div class="form-group">
						<label>Montant du préjudice</label>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="form-group">
						...
						<textarea class="form-control" LINE="10" rows="8" name="description" required>{{$AutreExpertise->description}}</textarea>
					</div>
				</div>
			</div>
			<div class="row">
