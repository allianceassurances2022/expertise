  ...
  <main>
    <p>
      <section style="display: block; width: 100%;">
        <h4 class="header-dif"><span style="display: inline-block;width: 55%;text-align: center;font-size: 13px;">PVE INCENDIE VEHICULE: {{now()->year}} / {{sprintf('%04d', $num_pv->num_pv)}}* </span> @if(auth()->user()->previllege != 'expert' ) <span style="display: inline-block;width: 45%;text-align: center;"> STATUT: {{$Status_expertise->libelle}}</span> @endif</h4>
      </section>
