...
@section('head_title')
Afféctation Utilisateur à Agence
@endsection

@section('title')
Afféctation des Utilisateurs à Agence Code : <a href="{{route('agences.show', $agence->id)}}">{{$agence->CODE}}</a>
		...
		<div class="col-12">
			<div class="card">
				...
				<div class="card-header">
					<h4 class="header-title"> <span class="fa fa-home"></span>Afféctation des Utilisateurs à Agence code : <a href="{{route('agences.show', $agence->id)}}">{{$agence->CODE}}</a> </h4>
				</div>
				<div class="card-body">
					<div class="row">
						<div class="col-lg-4 col-md-6 col-sm-12 mb-3">
							<div class="card">
								<div class="card-header">
									<h4 class="header-title"> <span class="fa fa-home"></span> Liste des Utilisateurs </h4>
								</div>
						...
						<div class="col-lg-4 col-md-6 col-sm-12 mb-3" >
							<div class="card">
								<div class="card-header pourAffecter">
									<h4 class="header-title"> <span class="fa fa-home"></span>   Liste des Utilisateurs à affectées</h4>
								</div>
								<div class="card-body collone">
									<table id="pourAffecterAgenceExpert" class=" table dataTable table-responsive table-hover display responsive nowrap" style="border-bottom:1px #0000004d solid;height: 450px; overflow: auto; width:100%; ">
								        <thead>
								            <tr>
						...
						<div class="col-lg-4 col-md-6 col-sm-12 mb-3" >
							<div class="card">
								<div class="card-header dejaAffecter">
									<h4 class="header-title"> <span class="fa fa-home"></span>   Liste des Utilisateurs déja affectées</h4>
								</div>
								<div class="card-body collone">
									<table id="dejaAffecte" class=" table table-hover display responsive nowrap " >
								        <thead>
								            <tr>
								                 <th class="all">CODE</th>
...
$( document ).ready(function() {
    ...
    var table = $('#expert').DataTable({
      ...
      "columns": [
		...
		"ajax": {
	  			"url": '{{route("agence.UserNonAffecteDataTable")}}',
            	"dataType": "json",
				"type": 'POST',
				"crossDomain": true,
	...
	if (items.length !== 0) { 
	    $.ajax({
	        ...
	        success: function(data) {
	                   ...
	                   window.location.href = '{{route("agences.showUsers",$agence->id )}}';

	                 },
	       error: function(xhr, status, error) {
	       				console.log(error);
	       				console.log(xhr);
	       				alert('Erreur: Il n\'y a pas d\'Utilisateur à affecter, '+error);
	       				// $('#btnAffecterListe').attr('disable', true);
	       } 
	    });
	}else{ alert('Il n\'y a pas d\'Utilisateur à affecter ');
...
$('#frmDesaffecterListe').on('submit' , function(e) {
	...
	}else{ alert('Il n\'y a pas d\'Utilisateur à désaffecter ');
