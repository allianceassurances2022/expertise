  ...
  <main>
    <p>
      <section style="display: block; width: 100%;">
        <h4 class="header-dif"><span style="display: inline-block;width: 55%;text-align: center;font-size: 13px;">PVE Carence:{{now()->year}} / {{sprintf('%04d', $num_pv->num_pv)}}* </span> @if(auth()->user()->previllege != 'expert' ) <span style="display: inline-block;width: 45%;text-align: center;"> STATUT: {{$Status_expertise->libelle}}</span> @endif</h4>
      </section>
      <section style="display: block; width: 100%;margin-top: 15px;clear: both;">
       ...
       <section style="display: block; width: 100%;margin-top: 15px;clear: both;margin-left: 10px;">
        <div style="font-size:12px;width:100% !important;border:1px black solid;border-radius: 5px; position: relative !important; display: inline-block; padding: 10px 2px 10px 2px; margin-left: -10px; vertical-align: top;margin-top:0px;">
          ...
          <h3 style="padding: 10px 5px; margin: 0; margin-bottom: 0px;text-align: center;background-color: #01737e;color:white;margin-right: -3px;margin-top: -11px;width: 100%;margin-left: -2px;border-radius: 5px 5px 0 0">Compte rendu</h3>
